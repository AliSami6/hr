            ...
            <div class="panel panel-info">
                ...
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    <div class="panel-body">
                        {{ Form::open(['route' => ['message.update', $message->id],  'class' => 'form-horizontal ajaxFormSubmit', 'id' => 'ajaxMessage', 'data-redirect' => route('message.index'), 'method' => 'PUT']) }}
                        <div class="form-body">
                             <div class="row">
                                <div class="col-md-8">
                                            ...
                                            <select class="form-control required role_name" name="receiver">
                                                ...
                                                @foreach ($users as $item)
                                                    <option value="{{ $item->first_name . ' ' . $item->last_name }}"
                                                        {{ $item->first_name . ' ' . $item->last_name == $message->receiver ? 'selected' : '' }}>
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                                ...
                                                <textarea class="form-control required role_name" name="message" cols="3" rows="4">{{ $message->message }} </textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
