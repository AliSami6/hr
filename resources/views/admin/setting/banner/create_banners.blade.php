            ...
            <div class="panel panel-info">
                ...
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    <div class="panel-body">
                        {{ Form::open(['route' => 'banner.store', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal ajaxFormSubmit', 'id' => 'ajaxBanner', 'data-redirect' => route('banner.index')]) }}
                        <div class="form-body">
                            <div class="row">
                                <div class="col-md-8">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <label class="control-label col-md-4">@lang('banners.image') (1920X1080)<span
                                                class="validateRq">*</span></label>
                                        <div class="col-md-8">
