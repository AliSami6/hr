            ...
            <div class="panel panel-info">
                ...
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    <div class="panel-body">
                        {{ Form::open(['route' => 'product.store', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal ajaxFormSubmit', 'id' => 'ajaxProduct', 'data-redirect' => route('product.index')]) }}
                        <div class="form-body">
                            <div class="row">
                                <div class="col-md-8">
                             ...
                             <div class="row">
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="form-control required role_name"
                                               id="discounted_price" name="discounted_price" value="{{ old('discounted_price') }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <label class="control-label col-md-4">@lang('products.image') (620X780)<span
                                                class="validateRq">*</span></label>
                                        <div class="col-md-8">
