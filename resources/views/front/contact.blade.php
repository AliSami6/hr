...
@section('content')
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s"
        style="background: url('{{ url('uploads/front/contact/' . $front_setting->contact_image) }}') center center;">
        ...
        <div class="container">
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <form action="{{ route('mail.msg') }}" method="POST">
                        {{ csrf_field() }}
                        <div class="row g-3">
                            <div class="col-md-6">
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <textarea class="form-control" name="msg" placeholder="Leave a message here" id="message" style="height: 250px"></textarea>
                                    <label for="message">Message</label>
                                </div>
                            </div>
                            <div class="col-12">
                                <button type="submit" class="btn btn-secondary rounded-pill py-3 px-5" type="submit">Send
                                    Message</button>
                            </div>
                        </div>
                    </form>
