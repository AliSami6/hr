...
@section('content')
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s"
        ...
        <div class="container text-center py-5">
            <h1 class="display-3 text-white mb-4 animated slideInDown">Job</h1>
                                ...
                                <form action="{{ route('job.application') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 py-2">
                                            <div class="form-group app-label">
                                                ...
                                                <input name="name" value="{{ old('name') }}" type="text"
                                                    class="form-control resume" placeholder="Applicant Name">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 py-2">
                                            <div class="form-group app-label">
                                                ...
                                                <input name="phone" value="{{ old('phone') }}" type="text"
                                                    class="form-control resume" placeholder="Phone No">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 py-2">
                                            <div class="form-group app-label">
                                        ...
                                        <div class="col-lg-12 py-2">
                                            ...
                                            <input type="submit" id="submit" class="submitBnt btn btn-primary mt-2"
                                                value="Apply">
                                        </div>
                                    </div>
                                </form>
