...
Route::group(['middleware' => ['preventbackbutton', 'auth']], function () {
    ...
    Route::get('setup-employee-attendance', ['as' => 'attendance.dashboard',
        'uses'                                        => 'Attendance\ManualAttendanceController@setupDashboardAttendance']);

    Route::post('setup-employee-attendance-post', ['as' => 'attendance.dashboard.post',
        'uses'                                              => 'Attendance\ManualAttendanceController@postDashboardAttendance']);

    Route::get('csv-attendance', ['as' => 'attendance.csv', 'uses' => 'Attendance\ManualAttendanceController@goToCsv']);
    Route::post('csv-attendance', ['as' => 'attendance.csv', 'uses' => 'Attendance\ManualAttendanceController@uploadCsvAttendance']);
    Route::get('csv-sample-download', ['as' => 'attendance.csv.download', 'uses' => 'Attendance\ManualAttendanceController@downloadEmployeeCsv']);
